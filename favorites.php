...
<body style="background: #2b343b; color: white;">
    ...
    <div class="row vhw">
        ...
        <?php include 'favorite_navbar.php'; ?>
        ...
        <div class="col p-3 m-2 overflow-auto scrollbar1">
            ...
            <nav class="navbar text-white">
                <div class="container-fluid">
                    ...
                    // get total number of favorite contacts
                    $query = mysqli_query($conn, "SELECT COUNT(*) as num_favorites FROM contacts WHERE favorite = true");
                    $result = mysqli_fetch_assoc($query);
                    $num_favorites = $result['num_favorites'];

                    ?>
                    <h4 class="navbar-brand text-white"><i class="fa-solid fa-list-ul"></i> You have <?php echo $result['num_favorites']; ?> Favorite Contacts</h4>
                    ...
                    <div class="col">
                        <table class="table table-dark table-striped table-hover table-responsive-md text-white py-3" id="table1">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM contacts WHERE favorite='1' ORDER BY id DESC";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <!-- Delete Action -->
                                                <button class="btn btn-outline-danger text-white" onclick="deleteModal('<?php echo $data['id']; ?>')">
